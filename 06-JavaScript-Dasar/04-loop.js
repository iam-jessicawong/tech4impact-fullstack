...
/// EDIT HERE
num = 2   //inisialisasi bilangan awal/bilangan mulainya langsung dari 2 karena satu sudah bukan prima jadi tidak perlu dicek lagi
while (primeCounter < 50) {   //perulangan akan terus berlangsung selama primeCounter belum mencapai 50
  ...
  for(div = 2; div < num-1; div++) {    //perulangan untuk membagi bilangan dengan setiap bilangan lain agar didapatkan faktornya
    if(num % div == 0) {    //jika bilangan tersebut habis dibagi dengan bilangan lain maka bukan prima
      prime = false
      break
    }
  }
...
num = 1   //inisialisasi bilangan awal yang akan dicek
do {
  if(num%2) {         //jika num % 2 hasilnya 1 (truthy value) maka bilangan ganjil, tambahkan counter dengan 1
    oddCounter += 1
  }
  if(oddCounter == 50) {      //mendapatkan bilangan ganjil ke 50
    const fiftiethOdd = num;
